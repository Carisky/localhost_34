...
class __TwigTemplate_3d68aa9c360ab6e2d06531344caf6e5d extends Template
{
    private $source;
    private $macros = [];
...
\$('#button-geo-zone').on('click', function () {
  ...
  ";
    ...
    html += '  <td class=\"text-start\"><select name=\"zone_to_geo_zone[' + zone_to_geo_zone_row + '][zone_id]\" class=\"form-select\" disabled><option value=\"0\">";
        // line 84
        echo twig_escape_filter($this->env, ($context["text_all_zones"] ?? null), "js");
...
";
    ...
    {
        return new Source("", "admin/view/template/localisation/geo_zone_form.twig", "C:\\OSPanel\\domains\\localhost\\admin\\view\\template\\localisation\\geo_zone_form.twig");
    }
}
