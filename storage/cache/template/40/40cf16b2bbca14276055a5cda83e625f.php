...
class __TwigTemplate_1ff95573e668288afa5bae87eb753509 extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t\t<input type=\"checkbox\" name=\"agree\" value=\"1\" ";
        ...
        echo ">
\t\t\t\t\t\t\t<b></b>
\t\t\t\t\t\t\t<div>Zapoznałem się i akceptuję <a href=\"/regulamin-sklepu\">Regulamin Sklepu</a> Internetowego, <a href=\"/polityka\">Politykę Prywatności</a> w celu realizacji zamówienia. *</div>
\t\t\t\t\t\t</label>
