...
class __TwigTemplate_d618c4be0891dbebe5b74e7c1c69bea9 extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t<td data-totals-subtotal>";
            // line 180
            echo twig_get_attribute($this->env, $this->source, ($context["totals"] ?? null), "subtotal", [], "any", false, false, false, 180);
            echo "</td>
\t\t\t\t\t</tr>
\t\t\t\t\t<tr>
\t\t\t\t\t\t<td>Rabat</td>
\t\t\t\t\t\t<td data-totals-discount>";
            // line 184
            echo twig_get_attribute($this->env, $this->source, ($context["totals"] ?? null), "discount", [], "any", false, false, false, 184);
            echo "</td>
\t\t\t\t\t</tr>
\t\t\t\t\t<tr>
\t\t\t\t\t\t<td>Wszystko</td>
\t\t\t\t\t\t<td data-totals-total>";
            // line 188
            echo twig_get_attribute($this->env, $this->source, ($context["totals"] ?? null), "total", [], "any", false, false, false, 188);
            echo "</td>
\t\t\t\t\t</tr>
\t\t\t\t</tbody>
\t\t\t</table>
