...
class __TwigTemplate_1e6778ce13589562d4ce89aa6cc14a75 extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t<button onclick=\"submitOrder()\" id=\"place-order\">Kupuję i płacę</button>
\t\t\t</div>
\t\t</section>
\t</body>
</html></main>";
...
<script type=\"text/javascript\" src=\"catalog/view/javascript/checkout/order.js\"></script>
</body></html>
";
    }
