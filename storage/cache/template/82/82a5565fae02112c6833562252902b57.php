...
class __TwigTemplate_b323ed2cc2d9b496a81b3b471208dc38 extends Template
{
    private $source;
    private $macros = [];
...
\t\t<script src=\"catalog/view/javascript/jquery/jquery-3.7.0.min.map\"></script>
\t\t<script src=\"catalog/view/javascript/jquery/jquery-2.1.1.min.map\"></script>
