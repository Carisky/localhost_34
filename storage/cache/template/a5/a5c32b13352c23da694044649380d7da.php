...
class __TwigTemplate_07f45482973d5731e66993f1d823600b extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t<div id=\"cart-button\" onClick=\"changeCartVis\" class=\"cart-button\">
\t\t\t\t<div id=\"cart-count-wrap\">
\t\t\t\t\t<div id=\"cart-count\">0</div>
\t\t\t\t\t</div>
\t\t\t\t\t<img height=25 id=\"cart-icon\" src=\"image/catalog/assets/add_to_cart_ico.svg\">
\t\t\t\t</div>
\t\t\t</div>
\t\t</header>
