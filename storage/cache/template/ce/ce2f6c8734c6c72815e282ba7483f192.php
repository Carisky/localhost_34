...
class __TwigTemplate_decea9cbccc99c27dac5bd755ceae5b8 extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t</li>
\t\t\t\t\t<li>
\t\t\t\t\t\t<a href=\"index.php?route=common/shop&category=kremy i smarowidła\">KREMY I SMAROWIDŁA</a>
\t\t\t\t\t</li>
\t\t\t\t\t<li>
...
\t\t\t\t\t</li>
\t\t\t\t\t<li>
\t\t\t\t\t\t<a href=\"index.php?route=common/shop&category=zestawy prezentowe\">ZESTAWY PREZENTOWE</a>
\t\t\t\t\t</li>
\t\t\t\t</ul>
\t\t\t\t<div class=\"bottom\">
\t\t\t\t\t<div>
