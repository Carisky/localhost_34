...
class __TwigTemplate_2a3d99d59e0668ed182801652affa23b extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t<a class=\"icon-wrap account-icon df aic jcc ta2\" href=\"/index.php?route=account/login\" style=\"width:250px\" data-fancybox>
...
\t\t</div>
\t\t<div class=\"popup-bottomRegister\" style=\"display: inline-block; margin-bottom:10px\">
\t\t\t<a class=\"icon-wrap account-icon df aic jcc ta2\" href=\"/index.php?route=account/register\" style=\"width:250px\" data-fancybox=\"\" data-close-popup=\"\">
\t\t\t\t<svg height=\"40\" width=\"40\">
\t\t\t\t\t<use xlink:href=\"/catalog/view/theme/noir/img/sprite.svg#user\"></use>
\t\t\t\t</svg>&nbsp;
...
\t\t\t\t\t\t\t<option value=\"\" disabled ";
                // line 40
                echo (( !twig_get_attribute($this->env, $this->source, ($context["address"] ?? null), "address_id", [], "any", false, false, false, 40)) ? (" selected") : (""));
                echo ">
\t\t\t\t\t\t\t\t--- Wybierz adres ---
\t\t\t\t\t\t\t</option>
\t\t\t\t\t\t\t";
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["item"]) {
                    // line 44
                    echo "\t\t\t\t\t\t\t\t<option value=\"";
                    echo twig_get_attribute($this->env, $this->source, $context["item"], "address_id", [], "any", false, false, false, 44);
                    echo "\" ";
                    echo (((twig_get_attribute($this->env, $this->source, $context["item"], "address_id", [], "any", false, false, false, 44) == twig_get_attribute($this->env, $this->source, ($context["address"] ?? null), "address_id", [], "any", false, false, false, 44))) ? (" selected") : (""));
                    echo ">
\t\t\t\t\t\t\t\t\t";
                    // line 45
                    echo twig_get_attribute($this->env, $this->source, $context["item"], "city", [], "any", false, false, false, 45);
                    echo ", ";
                    echo twig_get_attribute($this->env, $this->source, $context["item"], "address_1", [], "any", false, false, false, 45);
                    echo "
\t\t\t\t\t\t\t\t</option>
\t\t\t\t\t\t\t";
                }
...
\t\t\t\t\t\t\t\t\t\t<div class=\"buy-mark";
                    // line 163
                    echo ((twig_get_attribute($this->env, $this->source, (($__internal_compile_8 = ($context["cart_products"] ?? null)) && is_array($__internal_compile_8) || $__internal_compile_8 instanceof ArrayAccess ? ($__internal_compile_8[twig_get_attribute($this->env, $this->source, $context["product"], "product_id", [], "any", false, false, false, 163)] ?? null) : null), "packs", [], "any", false, false, false, 163)) ? (" active") : (""));
                    echo " ta posr\" data-mark>
\t\t\t\t\t\t\t\t\t\t\t<svg class=\"posa\">
\t\t\t\t\t\t\t\t\t\t\t\t<use xlink:href=\"/catalog/view/theme/noir/img/sprite.svg#check\"></use>
\t\t\t\t\t\t\t\t\t\t\t</svg>
...
\t\t\t\t\t\t\t<td data-totals-subtotal>";
            // line 182
            echo twig_get_attribute($this->env, $this->source, ($context["totals"] ?? null), "subtotal", [], "any", false, false, false, 182);
            echo "</td>
\t\t\t\t\t\t</tr>
\t\t\t\t\t\t<tr>
\t\t\t\t\t\t\t<td>Rabat</td>
\t\t\t\t\t\t\t<td data-totals-discount>";
            // line 186
            echo twig_get_attribute($this->env, $this->source, ($context["totals"] ?? null), "discount", [], "any", false, false, false, 186);
            echo "</td>
\t\t\t\t\t\t</tr>
\t\t\t\t\t\t<tr>
\t\t\t\t\t\t\t<td>Wszystko</td>
\t\t\t\t\t\t\t<td data-totals-total>";
            // line 190
            echo twig_get_attribute($this->env, $this->source, ($context["totals"] ?? null), "total", [], "any", false, false, false, 190);
            echo "</td>
\t\t\t\t\t\t</tr>
\t\t\t\t\t</tbody>
\t\t\t\t</table>
...
\t</form>
\t<script>
\t\t// Функция для отображения модального окна с сообщением и кнопкой OK
\t\tfunction nrShowMessage(message, type) {
\t\t\tvar overlay = document.createElement(\"div\");
\t\t\toverlay.id = \"nrShowMessageOverlay\";
...
\t\t\t\t\t\t// Выводим сообщение с номером заказа через модальное окно
\t\t\t\t\t\tnrShowMessage(json.message, 1);
\t\t\t\t\t\t// Очищаем список товаров и сбрасываем форму
\t\t\t\t\t\t\$('.wholesale-products').html('');
\t\t\t\t\t\t\$('#wholesale')[0].reset();
\t\t\t\t\t}
\t\t\t\t},
\t\t\t\terror: function(data) {
...
";
    ...
    {
        return array (  391 => 190,  384 => 186,  377 => 182,  368 => 175,  359 => 171,  345 => 163,  337 => 158,  330 => 156,  323 => 152,  313 => 147,  305 => 142,  294 => 136,  289 => 134,  282 => 130,  276 => 127,  269 => 125,  263 => 124,  257 => 123,  247 => 116,  242 => 114,  237 => 112,  226 => 105,  222 => 104,  202 => 88,  198 => 87,  187 => 81,  178 => 75,  165 => 67,  156 => 63,  147 => 59,  138 => 55,  135 => 54,  131 => 52,  125 => 48,  114 => 45,  107 => 44,  103 => 43,  97 => 40,  93 => 38,  91 => 37,  84 => 32,  63 => 13,  59 => 11,  57 => 10,  52 => 8,  48 => 7,  45 => 6,  43 => 5,  37 => 1,);
    }
