...
class __TwigTemplate_4ee763d3b8b2112195f791abdf77cd74 extends Template
{
    private $source;
    private $macros = [];
...
\t\t";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["script"]) {
            // line 55
            echo "\t\t\t <script src=\"";
            echo twig_get_attribute($this->env, $this->source, $context["script"], "href", [], "any", false, false, false, 55);
            echo "\" type=\"text/javascript\"></script>
\t\t";
        }
        $_parent = $context['_parent'];
...
\t\t\t\t\t\t\t<a href=\"";
            // line 148
            echo twig_get_attribute($this->env, $this->source, $context["category"], "href", [], "any", false, false, false, 148);
            echo "\">";
            echo twig_upper_filter($this->env, twig_get_attribute($this->env, $this->source, $context["category"], "name", [], "any", false, false, false, 148));
            echo "</a>
\t\t\t\t\t\t</li>
\t\t\t\t\t";
        }
...
";
    ...
    {
        return array (  291 => 151,  280 => 148,  277 => 147,  273 => 146,  188 => 63,  179 => 61,  174 => 60,  163 => 58,  158 => 57,  149 => 55,  144 => 54,  131 => 52,  127 => 51,  119 => 47,  113 => 45,  110 => 44,  104 => 42,  102 => 41,  98 => 40,  94 => 39,  68 => 15,  59 => 13,  55 => 12,  40 => 2,  37 => 1,);
    }
