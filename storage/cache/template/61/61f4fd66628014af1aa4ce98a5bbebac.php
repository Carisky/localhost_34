...
class __TwigTemplate_51491502a471599ab6b1a97f47e5e598 extends Template
{
    private $source;
    private $macros = [];
...
\t\t";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["script"]) {
            // line 51
            echo "\t\t\t <script src=\"";
            echo twig_get_attribute($this->env, $this->source, $context["script"], "href", [], "any", false, false, false, 51);
            echo "\" type=\"text/javascript\"></script>
\t\t";
        }
        $_parent = $context['_parent'];
...
\t\t\t\t<ul>
\t\t\t\t\t<li>
\t\t\t\t\t\t<a href=\"index.php?route=common/shop\">KONFITURY</a>
\t\t\t\t\t</li>
\t\t\t\t\t<li>
\t\t\t\t\t\t<a href=\"index.php?route=common/shop\">KREMY I SMAROWIDŁA</a>
\t\t\t\t\t</li>
\t\t\t\t\t<li>
\t\t\t\t\t\t<a href=\"index.php?route=common/shop\">MALUCHY W SPICHLERZU</a>
\t\t\t\t\t</li>
\t\t\t\t\t<li>
\t\t\t\t\t\t<a href=\"index.php?route=common/shop\">MIODY</a>
\t\t\t\t\t</li>
\t\t\t\t\t<li>
\t\t\t\t\t\t<a href=\"index.php?route=common/shop\">OWOCE W SYROPIE</a>
\t\t\t\t\t</li>
\t\t\t\t\t<li>
\t\t\t\t\t\t<a href=\"index.php?route=common/shop\">PRZETWORY WARZYWNE</a>
\t\t\t\t\t</li>
\t\t\t\t\t<li>
\t\t\t\t\t\t<a href=\"index.php?route=common/shop\">SYROPY</a>
\t\t\t\t\t</li>
\t\t\t\t\t<li>
\t\t\t\t\t\t<a href=\"index.php?route=common/shop\">ZESTAWY PREZENTOWE</a>
\t\t\t\t\t</li>
\t\t\t\t</ul>
\t\t\t\t<div class=\"bottom\">
\t\t\t\t\t<div>
...
";
    ...
    {
        return array (  184 => 59,  175 => 57,  170 => 56,  159 => 54,  154 => 53,  145 => 51,  140 => 50,  127 => 48,  123 => 47,  116 => 44,  110 => 42,  107 => 41,  101 => 39,  99 => 38,  95 => 37,  91 => 36,  68 => 15,  59 => 13,  55 => 12,  40 => 2,  37 => 1,);
    }
